        ...
        <div class="container">
            <div class="row">
                ...
                <div class="d-block d-md-none col-12 mt-4">
                    <div class="js-informative-banners-prev swiper-button-prev d-inline-block svg-icon-text">{% include "snipplets/svg/chevron-left.tpl" with {svg_custom_class: "icon-inline icon-xs"} %}</div>
                    <div class="js-informative-banners-pagination swiper-pagination-fraction font-small d-inline-block"></div>
                    <div class="js-informative-banners-next swiper-button-next d-inline-block svg-icon-text">{% include "snipplets/svg/chevron-right.tpl" with {svg_custom_class: "icon-inline icon-xs"} %}</div>
                </div>
            </div>
        </div>
    </section>
