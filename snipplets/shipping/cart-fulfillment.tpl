...
{% if show_cart_fulfillment %}
  <div class="js-fulfillment-info js-allows-non-shippable cart-fulfillment-info mb-3" {% if not cart.has_shippable_products %}style="display: none"{% endif %}>
  
    {% if not cart_page %}
      <div class="js-visible-on-cart-filled divider mb-0 mt-3" {% if cart.items_count == 0 %}style="display:none;"{% endif %}></div>
    {% endif %}
