...
{% set section_not_full_width_description_class =  not settings.full_width_description ? 'pt-md-5' %}
{% set section_class = 'section-products-related container-fluid mt-3 position-relative ' ~ section_not_full_width_description_class %}
{% set alternative_section_class = complementary_products ? ' pb-2' %}
{% set container_class = 'row mb-3 pb-2' %}
{% set title_container_class = 'col-md-3 mb-4 pt-md-5' %}
{% set title_class = 'h1 mb-0 mb-md-4' %}
{% set products_container_class = 'col-md-9 pr-0 pr-md-3' %}
...
{% set slider_controls_container_class = 'd-none d-md-block' %}
